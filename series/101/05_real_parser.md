...
~~~
request('http://files.biojs.net/chromosomes/manny.dummy', function (error, response, body) {
...
3. Download `files.biojs.net/chromosomes/manny.dummy` and print it to the screen
{% endhlblock  %}
